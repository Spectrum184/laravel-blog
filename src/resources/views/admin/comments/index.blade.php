        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li>
                        <a href="#" class="active">Comments Tables</a>
                    </li>
                </ol>
            </div>
        </div>
                        ...
                        <table id="bootstrap-data-table-export" class="
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{route('post', $comment->post->slug)}}">{{$comment->post->title}}</a>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="
                                                    btn btn-danger
                                                    mb-1
                                                " data-toggle="modal" data-target="#deleteModal-{{$comment->id}}">
                                            <i class="
                                                        fa fa-trash-o
                                                    "></i>
                                        </button>
            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{route('admin.comment.destroy', $comment->id)}}" style="display: none"
                            id="deleteComment-{{$comment->id}}" method="POST">
                            @csrf
                            @method('DELETE')
                        </form>
                    </div>
