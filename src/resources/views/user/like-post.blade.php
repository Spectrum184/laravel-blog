        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li>
                        <a href="#" class="active">Liked Posts Table</a>
                    </li>
                </ol>
            </div>
        </div>
                        ...
                        <table id="bootstrap-data-table-export" class="
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><button class="btn btn-danger mx-2"><i
                                                class="fa fa-heart"></i>{{$post->likedUsers->count()}}</button>
                                        <button class="btn btn-primary"><i
                                                class="fa fa-eye"></i>{{$post->view_count}}</button>
                                    </td>
