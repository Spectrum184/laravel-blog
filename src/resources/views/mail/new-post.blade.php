...
<body>
    ...
    <div class="container">
        ...
        <div class="load-more"><a href="{{route('post',$post->slug)}}" class="btn">Read
                More</a>
        </div>
        <div class="footer">
            <p>This mail is from tan blog.</p>
            <p>© <script>
                    let t = new Date(); document.write(t.getFullYear());
                </script> Tan. All rights reserved.</p>
        </div>
    </div>
</body>
