                ...
                <ul class="navbar-nav scrollable-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <div id="dropMenu" class="dropdown-menu menu1" style="display: none;">
                            ...
                            <a class="dropdown-item" href="{{ route('admin.dashboard') }}"><i class="fa fa-tv"
                            ...
                            <a href="{{route('user.profile')}}" class="dropdown-item"><i
                                    class="fa fa-user-circle"></i>&nbsp;{{Auth::user()->name}}</a>
                            <a class="dropdown-item" href="{{ route('user.dashboard') }}"><i class="fa fa-tv"
                                    aria-hidden="true"></i>&nbsp; Dashboard</a>
                            <a class="dropdown-item" href="{{route('user.like.post')}}" aria-hidden="true"><i
